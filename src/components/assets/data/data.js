...
export const price = [
  {
    ...
    list: [
      { id: 1, para: "Demo Content Install", icon: <FcCheckmark /> },
      { id: 2, para: "Theme Updates", icon: <FcCheckmark /> },
      { id: 3, para: "Support And Updates", icon: <AiOutlineClose /> },
      { id: 4, para: "Access All Themes", icon: <AiOutlineClose /> },
      { id: 5, para: "All Themes For Life", icon: <AiOutlineClose /> },
      { id: 6, para: "30 Days Money Back", icon: <AiOutlineClose /> },
    ],
  },
  {
    id: 2,
    ...
    list: [
      { id: 1, para: "Demo Content Install", icon: <FcCheckmark /> },
      { id: 2, para: "Theme Updates", icon: <FcCheckmark /> },
      { id: 3, para: "Support And Updates", icon: <FcCheckmark /> },
      { id: 4, para: "Access All Themes", icon: <FcCheckmark /> },
      { id: 5, para: "All Themes For Life", icon: <AiOutlineClose /> },
      { id: 6, para: "30 Days Money Back", icon: <AiOutlineClose /> },
    ],
  },
  {
    ...
    list: [
      ...
      { id: 3, para: "Support And Updates", icon: <FcCheckmark /> },
      { id: 4, para: "Access All Themes", icon: <FcCheckmark /> },
      { id: 5, para: "All Themes For Life", icon: <FcCheckmark /> },
      { id: 6, para: "30 Days Money Back", icon: <FcCheckmark /> },
    ],
  },
];
